    ...
    <div className="hero min-h-screen">
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        <div>
          ...
          <h1 className="text-5xl text-blue-300 font-serif my-5">MD. HAYAT HOSSAIN</h1>
          <TypeAnimation
            sequence={[
          ...
          <button className="btn btn-outline btn-primary ml-3"> <span className="text-white">Resume</span>  <img className="h-7" src={download} alt="" /> </button>
        </div>
      </div>
    </div>
  );
